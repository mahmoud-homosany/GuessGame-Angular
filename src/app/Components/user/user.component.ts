...
getUserNameFromToken(token: string | null): string {
 ...
 const userName = localStorage.getItem('userName'); 
  ...
  this.http.post<number>('https://guess-game.runasp.net/api/Auth/GetBestScore', body, { headers })
.subscribe({
...
console.log('Sending score update:', body);
  return this.http.post('https://guess-game.runasp.net/api/Auth/update-score', body, {
    headers: headers
  });
}
